...
const (
	...
	User_BatchUserInfo_FullMethodName = "/pb.User/BatchUserInfo"
)
...
func (c *userClient) BatchUserInfo(ctx context.Context, in *BatchUserInfoRequest, opts ...grpc.CallOption) (*BatchUserInfoResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(BatchUserInfoResponse)
	err := c.cc.Invoke(ctx, User_BatchUserInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	BatchUserInfo(context.Context, *BatchUserInfoRequest) (*BatchUserInfoResponse, error)
...
func (UnimplementedUserServer) BatchUserInfo(context.Context, *BatchUserInfoRequest) (*BatchUserInfoResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method BatchUserInfo not implemented")
}
...
func _User_BatchUserInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BatchUserInfoRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).BatchUserInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: User_BatchUserInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).BatchUserInfo(ctx, req.(*BatchUserInfoRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "BatchUserInfo",
			Handler:    _User_BatchUserInfo_Handler,
		},
	},
