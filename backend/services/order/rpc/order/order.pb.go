...
const file_order_proto_rawDesc = "" +
	"\n" +
	"\vorder.proto\x12\x02pb\"\x1d\n" +
	"\aRequest\x12\x12\n" +
	"\x04ping\x18\x01 \x01(\tR\x04ping\"\x1e\n" +
	"\bResponse\x12\x12\n" +
	"\x04pong\x18\x01 \x01(\tR\x04pong2*\n" +
	"\x05Order\x12!\n" +
	"\x04Ping\x12\v.pb.Request\x1a\f.pb.ResponseB\tZ\a./orderb\x06proto3"
...
var file_order_proto_depIdxs = []int32{
	0, // 0: pb.Order.Ping:input_type -> pb.Request
	1, // 1: pb.Order.Ping:output_type -> pb.Response
